...
document.addEventListener("keydown", (e) => {
	...
	if (noteDetail == null) return //premature exit from function

	noteDetail.active = true //it is adding active key to the note-details
...
document.addEventListener("keyup", (e) => {
	...
	noteDetail.active = false //it is adding active key to the note-details
	playNotes()
})
